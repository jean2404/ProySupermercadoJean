<%-- 
    Document   : ArticuloVista
    Created on : 19-jul-2021, 23:38:01
    Author     : sagit
--%>
            ...
            <div class="col-sm-6 mx-auto my-5">
                ...
                <x:form action="ArticuloControl">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>Precio</td><td><x:text property="pre" value='<%= f[2].toString()%>'/> </td>       
                        </tr>
                        <tr>
                            <td>Stock</td><td><x:text property="sto" value='<%= f[3].toString()%>'/> </td>       
                        </tr>
                        <tr>
                            <td colspan="2">
